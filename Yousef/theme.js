...
class specialHeader extends HTMLElement{
    connectedCallback(){
        ...
        <nav class="navbar">
            <div class="home-logo"><a href="../Yousef/index.html"><img src="../Yousef/Icons/learn.png">Learn<span>o</span></a></div>
            <ul>
            <li class="category" onclick=mustRegistration()><a class="mylink" href="../Yousef/categories.html">Categories</a></li>
            <li class="about"><a href="../Mohamed/about.html">About us</a></li>
            <li class="contact-us"><a href="../Hussein/ContactUsFinal.html">Contact</a></li>
            <li class="details"><a href="../Mazen/details.html">Details</a></li>
            <li class="sign-up"><a href="../mazen/login.php">Registration</a></li>
        ...
        <nav class="sidebar">
            ...
            <li class="contact-us"><a href="../Hussein/ContactUsFinal.html">Contact</a></li>
            <li class="details"><a href="../Mazen/details.html">Details</a></li>
            <li class="sign-up-side"><a href="../mazen/login.php">Registration</a></li>
            </ul>
        </nav>`
    }
}
...
class specialFooter extends HTMLElement{
    connectedCallback(){
        ...
        <footer>
            ...
            <h2>Permalinks</h2>
            <p><a href="../Yousef/index.html">Home</a></p>
            <p><a class="mylink" href="../Yousef/categories.html" onclick=mustRegistration()>Categories</a></p>
            <p><a href="../Mohamed/about.html">About us</a></p>
            <p><a href="../Hussein/ContactUsFinal.html">Contact</a></p>
            </div>
